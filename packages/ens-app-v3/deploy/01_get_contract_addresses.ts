...
const func: DeployFunction = async function (hre: HardhatRuntimeEnvironment) {
  ...
  const subgraphYamlPath = resolve(__dirname, '../../ens-subgraph/subgraph.yaml')
  ...
  console.log('Updated subgraph.yaml in packages/ens-subgraph with the local deployment addresses')
  ...
  console.log('Updated env.ts in packages/ens-subgraph with the env base domain')
}
