...
import { CheckSVG, CopySVG, UpArrowSVG } from '@ensdomains/thorin'
import { Neverable } from '@ensdomains/thorin/dist/types/types'
...
type BaseProps = {
  ...
  onClick?: () => void
  as?: 'button' | 'a'
  postfixIcon?: React.FunctionComponent<React.SVGProps<SVGSVGElement> & { title?: string }>
}
...
const Container = styled.button<{
  ...
  ({ theme, $inline }) => css`
    ...
    &:hover > ${PrefixContainer} > ${PrefixLabelsContainer} > ${PrefixLabel} {
      color: black;
    }
  `,
)
...
export const RecordItem = React.forwardRef<HTMLAnchorElement | HTMLButtonElement, Props>(
  (
    {
      as: asProp = 'button',
      link,
