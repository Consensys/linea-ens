import { registrySetResolverSnippet } from '@ensdomains/ensjs/contracts'
...
export const nameWrapperUnwrapAnyldSnippet = [
  ...nameWrapperErrors,
  {
    inputs: [
      {
...
export const nameWrapperOwnerOfSnippet = [...nameWrapperErrors, ...erc721OwnerOfSnippet] as const
