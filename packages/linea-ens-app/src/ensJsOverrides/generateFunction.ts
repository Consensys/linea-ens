...
import { TransactionRequestWithPassthrough } from '@ensdomains/ensjs/dist/types/types'
...
export const generateFunction = <
  TEncoderFn extends EncoderFunction,
  TDecoderFn extends DecoderFunction,
  TFunction extends GeneratedFunction<TEncoderFn, TDecoderFn> = GeneratedFunction<
    TEncoderFn,
    TDecoderFn
  >,
>({
