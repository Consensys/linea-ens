...
import { nameWrapperUnwrapAnyldSnippet, nameWrapperUnwrapSnippet } from './contracts/nameWrapper'
...
> = UnwrapNameDataParameters<TName> & WriteTransactionParameters<TChain, TAccount, TChainOverride>
...
>(
  ...
  { name, newOwnerAddress, newRegistrantAddress }: UnwrapNameDataParameters<TName>,
  ...
  if (nameType === 'eth-3ld') {
    ...
    return {
      ...
      data: encodeFunctionData({
        abi: nameWrapperUnwrapAnyldSnippet,
        functionName: 'unwrapAnyLD',
